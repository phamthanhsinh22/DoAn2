                                    ...
                                    <div class="block-wrapper">
                                        ...
                                        <div class="movie-meta">
                                            <div class="movie-title-1">
                                             {{$obj_sli->Title}}</div><span class="movie-title-2"></span>
                                          </div>
                ...
                <script data-cfasync="false"  type="application/ld+json">
                    {
                        ...
                        "name": "ANIME47.COM",
                        "alternateName": "ANIME47",
                        "potentialAction": {
                            "@type": "SearchAction",
                            "target": "https://anime47.com/tim-kiem/{keyword}/",
...
<ul class="list-top-movie">
  @foreach($obj_slider as $obj)
        ...
        <a class="list-top-movie-link"  href="{{URL('object/'.$obj->id)}}">
            <span class="status">12/12</span>
            <div class="list-top-movie-item-thumb" ></div>
            <img src="{{asset('assets/images/'.$obj->Images)}}" alt="">
